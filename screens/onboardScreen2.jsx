...
const OnboardingScreen2 = ({ navigation }) => {
  const handleGetStarted = () => {
    navigation.navigate('Onboarding3'); // Navigate to Home screen
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.upperitem} >
        <Text style={styles.maintext}> No Surge Pricing</Text>
        <Text style={styles.smalltext}>
          Non Commissioned Per KM Government Rate cards implementation For Fare Calculation  </Text>

        <Image style={styles.itemimage} source={require('../assets/Splash3.png')} />
        <Image style={styles.itemimage1} source={require('../assets/SC2.png')} />
      </View>
