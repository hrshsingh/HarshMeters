...
const OnboardingScreen3 = ({navigation}) => {
    ...
    const handleGetStarted = () => {
        navigation.navigate('allowlocation'); // Navigate to Home screen
      };
    
  return (
    <View style={styles.container}>
    <View style={styles.upperitem} >
        <Text style={styles.maintext}> Scan and Go</Text>
        <Text style={styles.smalltext}>
            Non Commissioned Per KM Government Rate cards implementation For Fare Calculation </Text>
       
        <Image style={styles.itemimage}  source={require('../assets/Splash4.png')}  />
        <Image style={styles.itemimage1} source={require('../assets/SC3.png')}  />
    </View>
